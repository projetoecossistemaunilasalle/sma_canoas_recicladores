...
import { publicationRoutes } from './routes/publications/publication.routes'
...
server.setErrorHandler((error, _request, reply) => {
    ...
    // Never send the raw error back to client as it can expose sensitive information.
    // Always send a generic message.
...
server.register(publicationRoutes, {
    prefix: '/publications',
})
